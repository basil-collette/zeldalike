...
public class PerlinNoise
{
    ...
    public float[,] GetNoiseMap(int width, int height)
    {
    ...
    public float Get2DNoiseAt(int xPos, int yPos)
    {
        return this.noise.GetNoise(xPos, yPos);
    }

    public float Get1DNoiseAtX(float pos)
    {
        return amplitude * this.noise.GetNoise(pos, 0);
    }

    public float Get1DNoiseAtY(float pos)
    {
        return amplitude * this.noise.GetNoise(0, pos);
    }
